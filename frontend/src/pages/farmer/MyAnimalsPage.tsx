  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-slate-900">Livestock & Herd Registry</h1>
          <p className="text-xs text-slate-500">
            Maintain your holdings, track vaccination due dates, and monitor clinical histories.
          </p>
        </div>
        ...
        {filteredAnimals.map((animal) => (
          ...
          >
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
              <span className="text-slate-400 text-[11px]">Village: Kallanur</span>
              <Link
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-xl space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <h3 className="font-bold text-base text-slate-900">Register Livestock</h3>
              <button
            ...
            <form onSubmit={handleRegisterAnimal} className="space-y-4">
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1">
                  Tag Number / Ear Tag ID <span className="text-rose-500">*</span>
                </label>
                <input
                  type="text"
                  required
                  placeholder="e.g. IN-TN-8722"
                  value={newTag}
